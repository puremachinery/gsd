...
Purpose: Confirm what assistant built actually works from user's perspective. One test at a time, plain text responses, no interrogation. When issues are found, automatically diagnose, plan fixes, and prepare for execution.
...
<execution_context>
@~/.claude/gsd/workflows/verify-work.md
@~/.claude/gsd/templates/UAT.md
</execution_context>
