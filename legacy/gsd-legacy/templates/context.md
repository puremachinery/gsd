...
- `gsd-phase-researcher` — Reads decisions to focus research (e.g., "card layout" → research card module patterns)
...
[Areas where user explicitly said "you decide" — assistant has flexibility here during planning/implementation]
...
- **assistant's Discretion** — Explicit acknowledgment of what assistant can decide during implementation.
