...
- Always reflects what assistant is doing RIGHT NOW
- If assistant reads this after /clear, it knows exactly where to resume
...
When assistant reads this file after /clear:
...
The file IS the debugging brain. assistant should be able to resume perfectly from any interruption point.
