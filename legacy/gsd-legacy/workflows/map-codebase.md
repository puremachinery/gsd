...
Documents are reference material for assistant when planning/executing. Always include actual file paths formatted with backticks: `src/services/user.ext`.
</philosophy>
...
- INTEGRATIONS.md - External APIs, databases, auth providers, callbacks
