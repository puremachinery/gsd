...
assistant's training data is 6-18 months stale. Always verify.

1. **Context7 MCP FIRST** - Current docs, no hallucination
2. **Official docs** - When Context7 lacks coverage
3. **WebSearch LAST** - For comparisons and trends only

See ~/.claude/gsd/templates/discovery.md `<discovery_protocol>` for full protocol.
</source_hierarchy>
...
7. **Create DISCOVERY.md** using ~/.claude/gsd/templates/discovery.md structure:
...
1. **Scope the discovery** using ~/.claude/gsd/templates/discovery.md:
...
7. **Create comprehensive DISCOVERY.md:**
   ...
   - Full structure from ~/.claude/gsd/templates/discovery.md
...
Use ~/.claude/gsd/templates/discovery.md.
